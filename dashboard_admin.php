...
<body>
    ...
    <main>
      <header class="main-header">
        ...
        <div class="search-bar">
          ...
          <input type="text" placeholder="Search books, users, or statistics...">
        </div>
      </header>
        ...
        <section class="recent-activity">
          ...
          <div class="activity-list">
            ...
            <div class="activity-item">
              ...
              <div class="activity-details">
                <p>"The Hobbit" was borrowed by Sarah Smith</p>
            ...
            <div class="activity-item">
              ...
              <div class="activity-details">
                <p>"1984" was returned by Mike Johnson</p>
  ...
  <script>
    ...
    logoutButton.onclick = () => modal.style.display = "block";
    ...
    document.getElementById('timeRange').addEventListener('change', function(e) {
      const ranges = {
        ...
        'year': { labels: ['Jan', 'Mar', 'May', 'Jul', 'Sep', 'Nov'] }
      };

      const range = ranges[e.target.value];
      lineChart.data.labels = range.labels;
      
      // Generate new random data
      lineChart.data.datasets[0].data = Array.from({length: range.labels.length}, 
        () => Math.floor(Math.random() * 30));
      lineChart.data.datasets[1].data = Array.from({length: range.labels.length}, 
        () => Math.floor(Math.random() * 30));
